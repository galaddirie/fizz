...
const getCursorStyle = (presence: UserPresence) => {
  ...
  return {
    ...
    transform: `translate3d(${presence.cursor.x}px, ${presence.cursor.y}px, 0) scale(${inverseZoom})`,
...
<template>
  <div class="collaborative-cursors pointer-events-none absolute top-0 left-0 h-0 w-0 overflow-visible">
      ...
      <div v-for="presence in visibleCursors" :key="presence.user.id"
        ...
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <path
            ...
            :fill="getCursorColor(presence.user)" :stroke="getCursorColor(presence.user)" stroke-width="2"
