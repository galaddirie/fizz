...
<template>
  <div class="subnode-wrapper group flex flex-col items-center">
    ...
    <div
      class="absolute -top-[3px] left-1/2 z-10 -translate-x-1/2 -translate-y-1/2"
    >
    ...
    <div
      :class="[
        ...
        hasStatusStyle
          ? ''
          : 'border-base-300/60 shadow-[0_4px_10px_rgba(0,0,0,0.08)]',
        props.dragging
    ...
    >
      ...
      <component
        v-else
        :is="IconComponent"
        class="text-base-content/80 size-7"
      />
