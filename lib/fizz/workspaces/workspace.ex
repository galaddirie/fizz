defmodule Fizz.Workspaces.Workspace do
  @moduledoc """
  project-scoped persistent Workspace descriptor.
  """

  use Fizz.Schema

  alias Fizz.Accounts.{Project, User}
  alias Fizz.Workspaces.{Checkpoint, ConsoleSession, ExecJob, Service}
  ...
  def changeset(workspace, attrs) do
    ...
    |> unique_constraint(:name, name: :workspaces_project_id_name_index)
  end
end
