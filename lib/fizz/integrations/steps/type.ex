defmodule Fizz.Integrations.Steps.Type do
  @moduledoc """
  ...
  Step types are defined using `Fizz.Integrations.Steps.Definition` in executor modules
  and registered in `Fizz.Integrations.Steps.Registry` at startup.
  ...
  To list all types:
      ...
      types = Fizz.Integrations.Steps.Registry.all()
  """
