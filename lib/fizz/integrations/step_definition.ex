defmodule Fizz.Integrations.StepDefinition do
  @moduledoc """
  ...
  `Fizz.Integrations.StepRegistry` and validates required metadata at compile time.
  ...
  defmacro __using__(opts) do
    ...
    for key <- @required_opts do
      unless Keyword.has_key?(opts, key) do
        raise ArgumentError, "#{key} is required for Fizz.Integrations.StepDefinition"
      end
    end
    ...
    quote do
      @before_compile Fizz.Integrations.StepDefinition
