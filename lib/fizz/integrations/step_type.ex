defmodule Fizz.Integrations.StepType do
  @moduledoc """
  ...
  Step types are defined using `Fizz.Integrations.StepDefinition` in executor modules
  and registered in `Fizz.Integrations.StepRegistry` at startup.
  ...
  To list all types:
      ...
      types = Fizz.Integrations.StepRegistry.all()
  """
