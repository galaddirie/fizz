defmodule Fizz.Executions.Execution do
  @moduledoc """
  ...
  defmodule Trigger do
    ...
    @type t :: %__MODULE__{
            type: Fizz.Executions.Execution.trigger_type(),
            data: map()
          }
  ...
  def changeset(execution, attrs) do
    ...
    |> validate_required([:workflow_id, :workspace_id, :status, :execution_type])
  ...
  @doc """
  Filters executions by WorkOS organization id.
  """
  ...
  def for_organization(queryable \\ __MODULE__, organization_id)
    ...
    from e in queryable, where: e.workspace_id in subquery(workspace_ids_query)
  end

  @doc """
  Filters executions by workspace id.
  """
  ...
  def for_workspace(queryable \\ __MODULE__, workspace_id) when is_binary(workspace_id) do
    from e in queryable, where: e.workspace_id == ^workspace_id
  end

  @doc """
  Filters executions by triggering user id.
  """
  @spec triggered_by(Ecto.Queryable.t(), Ecto.UUID.t()) :: Ecto.Query.t()
  def triggered_by(queryable \\ __MODULE__, user_id) when is_binary(user_id) do
    from e in queryable, where: e.triggered_by_user_id == ^user_id
  end
