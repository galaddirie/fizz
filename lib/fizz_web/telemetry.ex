defmodule FizzWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("fizz.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("fizz.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("fizz.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("fizz.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
