defmodule FizzWeb do
  ...
  defp html_helpers do
    quote do
      ...
      use LiveVue.Components, vue_root: ["./assets/vue", "./lib/fizz_web"]

      # HTML escaping functionality
      import Phoenix.HTML
      # Core UI components
      import FizzWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: FizzWeb.Router,
        statics: FizzWeb.static_paths()
    end
  end
